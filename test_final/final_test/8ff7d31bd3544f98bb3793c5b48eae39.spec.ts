...
test('Generated Test', async () => {
  ...
  try {
    ...
    if (!setupError && page) {
      const steps = [
        ...
        },
        {
          ...
          "waitTimeoutMs": 10000,
          "retry": 3,
          "fallbacks": ["[data-test='username']", "input[placeholder='Username']"],
        ...
        },
        {
          ...
          "waitTimeoutMs": 10000,
          "retry": 3,
          "fallbacks": ["[data-test='password']", "input[placeholder='Password']"],
        ...
        },
        {
          ...
          "waitTimeoutMs": 10000,
          "retry": 3,
          "fallbacks": ["button[data-test='add-to-cart-sauce-labs-backpack']", "text=Add to cart"],
        ...
        },
        {
          ...
          "waitTimeoutMs": 10000,
          "retry": 3,
          "fallbacks": [".inventory_item_name:has-text('Sauce Labs Backpack')"],
        ...
        },
        {
          ...
          "waitTimeoutMs": 10000,
          "retry": 3,
          "fallbacks": ["button[data-test='checkout']"],
        ...
        },
        {
          ...
          "waitTimeoutMs": 10000,
          "retry": 3,
          "fallbacks": ["[data-test='firstName']", "input[placeholder='First Name']"],
        ...
        },
        {
          ...
          "waitTimeoutMs": 10000,
          "retry": 3,
          "fallbacks": ["[data-test='lastName']", "input[placeholder='Last Name']"],
        ...
        },
        {
          ...
          "waitTimeoutMs": 10000,
          "retry": 3,
          "fallbacks": ["[data-test='postalCode']", "input[placeholder='Zip/Postal Code']"],
        ...
        },
        {
          ...
          "waitTimeoutMs": 10000,
          "retry": 3,
          "fallbacks": ["input[data-test='continue']"],
        ...
        },
        {
          ...
          "waitTimeoutMs": 10000,
          "retry": 3,
          "fallbacks": ["button[data-test='finish']"],
        ...
        },
        {
          ...
          "waitTimeoutMs": 10000,
          "retry": 3,
          "fallbacks": ["button[data-test='back-to-products']"],
        ...
        },
        {
          ...
          "retry": 3,
          "fallbacks": [],
          "errorMessage": "Failed to click on logout button",
    ...
    try {
      fs.writeFileSync('8ff7d31bd3544f98bb3793c5b48eae39.json', JSON.stringify(result, null, 2));
    } catch (writeError) {
