...
test('Generated Test', async () => {
  ...
  const originalUserSteps: string[] = [
    ...
    "Ensure that the product \"Sauce Labs Backpack\" is present in the cart with data-test inventory-item.",
    ...
    if (!setupError && page) {
      const steps = [
        ...
        },
        {
          ...
          "retry": 3,
          "fallbacks": [],
          "errorMessage": "Could not fill username field with 'standard_user'.",
        ...
        },
        {
          ...
          "retry": 3,
          "fallbacks": [],
          "errorMessage": "Could not fill password field with 'secret_sauce'.",
        ...
        },
        {
          ...
          "errorMessage": "Could not click the product sort filter dropdown.",
        ...
        },
        {
          ...
          "errorMessage": "Could not click the Add to Cart button for 'Sauce Labs Backpack'.",
        ...
        },
        {
          ...
          "stepDescription": "Ensure that the product \"Sauce Labs Backpack\" is present in the cart with data-test inventory-item."
        },
        {
          "action": "click",
          "selector": "#checkout",
        ...
        },
        {
          ...
          "retry": 3,
          "fallbacks": [],
          "errorMessage": "Could not fill first name field with 'chaitanya'.",
        ...
        },
        {
          ...
          "retry": 3,
          "fallbacks": [],
          "errorMessage": "Could not fill last name field with 'Kompella'.",
        ...
        },
        {
          ...
          "retry": 3,
          "fallbacks": [],
          "errorMessage": "Could not fill postal code field with '62567352'.",
        ...
        },
        {
          ...
          "errorMessage": "Text 'Thank you for your order!' is not present.",
        ...
        },
        {
          ...
          "errorMessage": "User is not logged out",
          "stepDescription": "Keep the browser open after the test execution is complete."
        }
      ];
