...
test('Generated Test', async () => {
  ...
  const stepsFromInput = [
    ...
    },
    {
      ...
      "retry": 0,
      "fallbacks": [],
      "errorMessage": "Login button is not visible.",
      "stepDescription": "Verify login button is visible"
    },
    {
      "action": "click",
      "selector": "#login-button",
    ...
    },
    {
      ...
      "retry": 0,
      "fallbacks": [],
      "errorMessage": "Navigation after login failed or timed out.",
      "stepDescription": "Wait for network to be idle after login"
    },
    {
      "action": "click",
    ...
    {
      "action": "click",
      "selector": "option[value=\"price:asc\"]",
      "value": null,
      "waitTimeoutMs": 0,
      "retry": 3,
      "fallbacks": [
      ...
      "errorMessage": "Failed to select 'Price (low to high)' from the dropdown.",
      "stepDescription": "Select \"Price (low to high)\" from the dropdown"
    },
    {
      "action": "isVisible",
      ...
      "retry": 0,
      "fallbacks": [],
      "errorMessage": "Add to cart button is not visible.",
      "stepDescription": "Verify 'Add to cart' button is visible"
    },
    {
      "action": "click",
      "selector": "#add-to-cart-sauce-labs-backpack",
    ...
    },
    {
      ...
      "retry": 0,
      "fallbacks": [],
      "errorMessage": "Cart icon is not visible.",
      "stepDescription": "Verify cart icon is visible"
    },
    {
      "action": "click",
      "selector": "[data-test=\"shopping-cart-link\"]",
    ...
    },
    {
      ...
      "retry": 0,
      "fallbacks": [],
      "errorMessage": "Product is not in the cart.",
      "stepDescription": "Verify that the product is in the cart"
    },
    {
      "action": "click",
      "selector": "#checkout",
    ...
    },
    {
      ...
      "stepDescription": "Verify the success message"
    },
    {
      "action": "click",
      ...
      "errorMessage": "Failed to click back to home.",
          ...
          try {
            switch (stepData.action) {
              ...
              case "waitForLoadState":
                await page.waitForLoadState(stepData.value as any);
                stepDetails = `Waited for load state ${stepData.value}`;
                break;
              default:
                stepStatus = "error";
