...
test('Generated Test', async () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      "retry": 2,
      "fallbacks": ["scrollIntoView"],
      "errorMessage": "Failed to click sort dropdown",
    ...
    },
    {
      ...
      "retry": 2,
      "fallbacks": ["scrollIntoView"],
      "errorMessage": "Failed to verify that Sauce Labs Backpack is present in the cart",
    ...
    },
    {
      ...
      "retry": 2,
      "fallbacks": ["scrollIntoView"],
      "errorMessage": "Failed to verify the text 'Thank you for your order!'",
