...
test('Generated Test', async () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      "errorMessage": "Failed to click add to cart button after multiple retries.",
    ...
    },
    {
      ...
      "errorMessage": "Product 'Sauce Labs Backpack' is not visible in the cart after multiple retries.",
    ...
    },
    {
      ...
      "errorMessage": "Text 'Thank you for your order!' is not visible after multiple retries.",
          ...
          try {
            switch (stepData.action) {
              ...
              case "waitFor":
                ...
                stepDetails = `Waited for 5 seconds`;
                break;
              case "isVisible":
                try {
                  await page.locator(stepData.selector).waitFor({ timeout: 5000 });
