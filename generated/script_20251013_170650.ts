...
test('Generated Test', async () => {
  ...
  const originalUserSteps: string[] = [
    ...
    "Click the burger bar button with id react-burger-menu-btn",
  ...
  const stepsFromInput = [
    ...
    },
    {
      ...
      "stepDescription": "Click the product sort filter dropdown with class product_sort_container"
    },
    {
      "action": "click",
    ...
    },
    {
      ...
      "stepDescription": "Click the cart icon with class shopping_cart_link"
    },
    {
      "action": "isVisible",
    ...
    },
    {
      ...
      "stepDescription": "Click the checkout button with id checkout"
    },
    {
      "action": "fill",
      "selector": "#first-name",
    ...
    },
    {
      ...
      "stepDescription": "Click the continue button with id continue"
    },
    {
      "action": "click",
      "selector": "#finish",
      ...
      "stepDescription": "Click the finish button with id finish"
    },
    {
      "action": "isVisible",
    ...
    },
    {
      ...
      "stepDescription": "Click the back to home button with id back-to-products"
    },
    {
      "action": "click",
      ...
      "stepDescription": "Click the burger bar button with id react-burger-menu-btn"
    },
    {
      "action": "click",
      ...
      "stepDescription": "Click the logout button with id logout_sidebar_link"
    }
  ];
