...
test('Generated Test', async () => {
  ...
  const originalUserSteps: string[] = [
    ...
    "Click on the cart icon with class shopping_cart_link to verify that the product has been added.",
  ...
  const steps = [
    ...
    },
    {
      ...
      "stepDescription": "Click on the cart icon with class shopping_cart_link to verify that the product has been added."
    },
    {
      "action": "isVisible",
      "selector": ".cart_item",
