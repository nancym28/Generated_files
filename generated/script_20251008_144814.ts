  ...
  const stepsFromInput = [
    {
      ...
      "retry": 3,
      "fallbacks": [],
      "errorMessage": "Failed to navigate to the application dashboard after multiple retries.",
      "stepDescription": "Navigate to the application dashboard"
    },
    {
      "action": "click",
      "selector": "#systemSettingsMenu",
      "value": null,
      "waitTimeoutMs": 5000,
      "retry": 2,
      "fallbacks": [],
      "errorMessage": "Failed to click on the system settings menu after multiple retries.",
      "stepDescription": "Click on system settings menu"
    },
    {
      "action": "click",
      "selector": "#shutdownOption",
      "value": null,
      "waitTimeoutMs": 5000,
      "retry": 2,
      "fallbacks": [],
      "errorMessage": "Failed to click on the shutdown option after multiple retries.",
      "stepDescription": "Click on shutdown option"
    },
    {
      "action": "click",
      "selector": "#confirmShutdownButton",
      "value": null,
      "waitTimeoutMs": 5000,
      "retry": 2,
      "fallbacks": [],
      "errorMessage": "Failed to confirm shutdown action after multiple retries.",
      "stepDescription": "Confirm shutdown action"
    },
    {
      "action": "isVisible",
      "selector": "#shutdownConfirmationMessage",
      "value": null,
      "waitTimeoutMs": 10000,
      "retry": 3,
      "fallbacks": [],
      "errorMessage": "Shutdown confirmation message is not visible after multiple retries.",
