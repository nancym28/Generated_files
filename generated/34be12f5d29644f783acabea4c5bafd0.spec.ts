...
test('Generated Test', async () => {
  ...
  try {
    ...
    if (!setupError && page) {
      ...
      const steps = [
        ...
        },
        {
          ...
          "stepDescription": "Enter 'standard_user' into username field"
        },
        {
          "action": "fill",
          "selector": "#password",
          ...
          "stepDescription": "Enter 'secret_sauce' into password field"
        },
        {
          "action": "click",
    ...
    try {
      require('fs').writeFileSync('34be12f5d29644f783acabea4c5bafd0.json', JSON.stringify(result, null, 2));
    } catch (writeError) {
