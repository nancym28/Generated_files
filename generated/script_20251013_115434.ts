...
test('Generated Test', async () => {
  ...
  const originalUserSteps: string[] = [
    ...
    "Ensure that the message “Thank you for your order!” is displayed",
  ...
  const steps = [
    ...
    },
    {
      ...
      "retry": 2,
      "fallbacks": [],
      "errorMessage": "Failed to click Add to Cart button for the product \"Sauce Labs Backpack\" after multiple retries.",
    ...
    },
    {
      ...
      "retry": 2,
      "fallbacks": [],
      "errorMessage": "Failed to click on the cart icon after multiple retries.",
    ...
    },
    {
      ...
      "retry": 2,
      "fallbacks": [],
      "errorMessage": "Failed to ensure that the product \"Sauce Labs Backpack\" is present in the cart after multiple retries.",
    ...
    },
    {
      ...
      "retry": 2,
      "fallbacks": [],
      "errorMessage": "Failed to click on the checkout button after multiple retries.",
    ...
    },
    {
      ...
      "retry": 2,
      "fallbacks": [],
      "errorMessage": "Failed to enter \"chaitanya\" in the first name field after multiple retries.",
    ...
    },
    {
      ...
      "retry": 2,
      "fallbacks": [],
      "errorMessage": "Failed to enter \"Kompella\" in the last name field after multiple retries.",
    ...
    },
    {
      ...
      "retry": 2,
      "fallbacks": [],
      "errorMessage": "Failed to enter \"62567352\" in the postal code field after multiple retries.",
    ...
    },
    {
      ...
      "retry": 2,
      "fallbacks": [],
      "errorMessage": "Failed to click on continue button after multiple retries.",
    ...
    },
    {
      ...
      "retry": 2,
      "fallbacks": [],
      "errorMessage": "Failed to click on finish button after multiple retries.",
    ...
    },
    {
      ...
      "retry": 2,
      "fallbacks": [],
      "errorMessage": "Failed to ensure that the message “Thank you for your order!” is displayed after multiple retries.",
      "stepDescription": "Ensure that the message “Thank you for your order!” is displayed"
    },
    {
      "action": "click",
      ...
      "retry": 2,
      "fallbacks": [],
      "errorMessage": "Failed to click on back to home button after multiple retries.",
    ...
    },
    {
      ...
      "retry": 2,
      "fallbacks": [],
      "errorMessage": "Failed to click on the burger bar after multiple retries.",
    ...
    },
    {
      ...
      "retry": 2,
      "fallbacks": [],
      "errorMessage": "Failed to click on logout after multiple retries.",
