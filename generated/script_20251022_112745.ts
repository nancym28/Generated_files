...
test('Generated Test', async () => {
  ...
  const originalUserSteps: string[] = [
    ...
    "Verify 'Sauce Labs Backpack' is present in the cart.",
    "Click on the checkout button.",
    "Enter 'chaitanya' in the first name field.",
    "Enter 'Kompella' in the last name field.",
    "Enter '62567352' in the postal code field.",
    ...
    if (!setupError && page) {
      const steps = [
        ...
        },
        {
          ...
          "stepDescription": "Click 'Add to Cart' for the 'Sauce Labs Backpack'."
        },
        {
          "action": "click",
        ...
        },
        {
          ...
          "retry": 3,
          "fallbacks": ["scrollIntoView"],
          "errorMessage": "'Sauce Labs Backpack' not found in the cart.",
          "stepDescription": "Verify 'Sauce Labs Backpack' is present in the cart."
        },
        {
          "action": "click",
        ...
        },
        {
          ...
          "stepDescription": "Verify the 'Thank you for your order!' message is displayed."
        },
        {
          "action": "click",
