...
test('Generated Test', async () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      "waitTimeoutMs": 10000,
      "retry": 2,
      "fallbacks": ["[data-test='username']", "input[name='user-name']", "input[placeholder='Username']"],
    ...
    },
    {
      ...
      "waitTimeoutMs": 10000,
      "retry": 2,
      "fallbacks": ["[data-test='password']", "input[name='password']", "input[placeholder='Password']"],
    ...
    },
    {
      ...
      "waitTimeoutMs": 15000,
      "retry": 3,
      "fallbacks": ["[data-test='login-button']", "input[name='login-button']", "input[value='Login']"],
