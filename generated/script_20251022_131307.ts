...
test('Generated Test', async () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      "waitTimeoutMs": 5000,
      "retry": 2,
      "fallbacks": ["option[value='za']"],
      "errorMessage": "Failed to select Name (Z to A) from the product sort filter.",
    ...
    },
    {
      ...
      "waitTimeoutMs": 5000,
      "retry": 3,
      "fallbacks": ["[data-test='add-to-cart-sauce-labs-backpack']", "button:has-text('Add to cart')"],
    ...
    },
    {
      ...
      "waitTimeoutMs": 5000,
      "retry": 2,
      "fallbacks": ["[data-test='inventory-item']:has-text('Sauce Labs Backpack')"],
