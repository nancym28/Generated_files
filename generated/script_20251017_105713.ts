...
test('Generated Test', async () => {
  ...
  const originalUserSteps: string[] = [
    ...
    "Verify text \"Thank you for your order!\" is present on page",
    ...
    if (!setupError && page) {
      const steps = [
        ...
        },
        {
          ...
          "retry": 3,
          "fallbacks": [],
          "errorMessage": "Failed to click product sort filter after multiple retries.",
          "stepDescription": "Click on the product sort filter dropdown with class product_sort_container"
        },
        {
          "action": "click",
          "selector": ".product_sort_container > option[value='az']",
          "value": null,
          "waitTimeoutMs": 30000,
          "retry": 3,
          "fallbacks": [],
          "errorMessage": "Failed to select sort option after multiple retries.",
          "stepDescription": "Select \"Name (A to Z)\""
        },
        {
          "action": "click",
          ...
          "retry": 3,
          "fallbacks": [],
          "errorMessage": "Failed to add Sauce Labs Backpack to cart after multiple retries.",
        ...
        },
        {
          ...
          "retry": 3,
          "fallbacks": [],
          "errorMessage": "Failed to click cart icon after multiple retries.",
        ...
        },
        {
          ...
          "retry": 3,
          "fallbacks": [],
          "errorMessage": "Sauce Labs Backpack is not present in the cart after multiple retries.",
        ...
        },
        {
          ...
          "retry": 3,
          "fallbacks": [],
          "errorMessage": "Thank you message is not present after multiple retries.",
          "stepDescription": "Verify text \"Thank you for your order!\" is present on page"
        },
        {
          "action": "click",
