    ...
    if (!setupError && page) {
      const steps = [
        ...
        },
        {
          ...
          "stepDescription": "Type 'standard_user' into the username field."
        },
        {
          "action": "fill",
          "selector": "#password",
          ...
          "stepDescription": "Type 'secret_sauce' into the password field."
        },
        {
          "action": "click",
        ...
        },
        {
          ...
          "stepDescription": "Assert that the product 'Sauce Labs Backpack' is present in the cart."
        },
        {
          "action": "click",
          "selector": "#checkout",
        ...
        },
        {
          ...
          "retry": 3,
          "fallbacks": ["scrollIntoView"],
          "errorMessage": "Failed to type 'chaitanya' into the first name field.",
          "stepDescription": "Type 'chaitanya' into the first name field."
        },
        {
          "action": "fill",
          "selector": "#last-name",
          ...
          "retry": 3,
          "fallbacks": ["scrollIntoView"],
          "errorMessage": "Failed to type 'Kompella' into the last name field.",
          "stepDescription": "Type 'Kompella' into the last name field."
        },
        {
          "action": "fill",
          ...
          "retry": 3,
          "fallbacks": ["scrollIntoView"],
          "errorMessage": "Failed to type '62567352' into the postal code field.",
          "stepDescription": "Type '62567352' into the postal code field."
        },
        {
          "action": "click",
          "selector": "#continue",
