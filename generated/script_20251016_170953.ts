...
test.setTimeout(120000); // Increased timeout for the entire test
    ...
    if (!setupError && page) {
      const steps = [
        ...
        },
        {
          ...
          "retry": 2,
          "fallbacks": [],
          "errorMessage": "Failed to select Name (A to Z) from dropdown",
          ...
          try {
            switch (stepData.action) {
              ...
              case "hover":
                ...
                break;
              case "waitFor":
                // Intentionally empty, as waitFor with no selector is meant to keep browser open
