...
test('Generated Test', async () => {
  ...
  try {
    ...
    if (!setupError && page) {
      const steps = [
        ...
        },
        {
          ...
          "retry": 3,
          "fallbacks": ["scrollIntoView"],
          "errorMessage": "Thank you for your order! message is not displayed",
    ...
    try {
      require('fs').writeFileSync('50f1abea614c47a1a7d11bc9e5092487.json', JSON.stringify(result, null, 2));
    } catch (writeError) {
