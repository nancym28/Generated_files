...
test('Generated Test', async () => {
  ...
  try {
    ...
    if (!setupError && page) {
      const steps = [
        ...
        },
        {
          ...
          "retry": 3,
          "fallbacks": ["scrollIntoView"],
          "errorMessage": "Failed to verify the presence of the text “Thank you for your order!”",
        ...
        },
        {
          ...
          "retry": 3,
          "fallbacks": ["scrollIntoView", "waitForLoadState"],
          "errorMessage": "Failed to click on the burger menu button",
          "stepDescription": "Click on the burger menu button"
        },
        {
          "action": "click",
    ...
    try {
      fs.writeFileSync('cab4bb2053244c5689a8a4b7c27ef74b.json', JSON.stringify(result, null, 2));
    } catch (writeError) {
