...
test('Generated Test', async () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      "retry": 3,
      "fallbacks": [],
      "errorMessage": "Failed to ensure that the product 'Sauce Labs Backpack' is present in the cart.",
    ...
    },
    {
      ...
      "retry": 3,
      "fallbacks": [],
      "errorMessage": "Failed to enter '62567352' in postal code field.",
    ...
    },
    {
      ...
      "retry": 3,
      "fallbacks": [],
      "errorMessage": "Failed to assert that the text 'Thank you for your order!' is present.",
