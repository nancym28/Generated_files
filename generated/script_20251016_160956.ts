...
test('Generated Test', async () => {
  ...
  const originalUserSteps: any[] = [
    ...
    {
      "action": "waitFor",
      "selector": "div.oxd-topbar",
      "value": null,
      "waitTimeoutMs": 10000,
      "retry": 0,
      "fallbacks": [],
      "errorMessage": "Dashboard did not load",
      "stepDescription": "Wait for dashboard to load"
    },
    {
      "action": "isVisible",
      "selector": "div.oxd-topbar-header-title > h6",
      "value": null,
      "waitTimeoutMs": 5000,
      "retry": 0,
      "fallbacks": [],
      "errorMessage": "Dashboard heading not visible",
      "stepDescription": "Verify dashboard heading visibility"
    },
    {
      "action": "click",
      "selector": "span.oxd-userdropdown-name",
      "value": null,
      "waitTimeoutMs": 5000,
      "retry": 0,
      "fallbacks": [],
